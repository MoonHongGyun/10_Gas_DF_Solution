...
{
	imwrite("C:\\Users\\IOT\\Desktop\\testfile\\shape.jpg", mat_frame);
...
void CGasDFClntDlg::OnTimer(UINT_PTR nIDEvent)
{
	...
	HDC dc = ::GetDC(m_Cam.m_hWnd);
	cimage_mfc.BitBlt(dc, 0, 0);

	::ReleaseDC(m_Cam.m_hWnd, dc);
